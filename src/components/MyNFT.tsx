...
export function MyNFT() {
  ...
  // [수정됨] 검색 범위를 100 -> 1000으로 늘려 NFT가 많아져도 보이도록 변경
  const [maxTokenId, setMaxTokenId] = useState(1000)
  ...
  return (
    <div className="space-y-6 text-black dark:text-white">
      <div className="flex justify-between items-center">
        <div>
          <h2 className="text-2xl font-bold text-black dark:text-white">내 NFT</h2>
      ...
      {isLoading ? (
        ...
        <div className="p-8 bg-white dark:bg-gray-800 rounded-lg shadow-lg text-center border border-gray-200 dark:border-gray-700">
...
function NFTCard({
  ...
  return (
    <div className="p-4 bg-white dark:bg-gray-800 rounded-lg shadow-lg hover:shadow-xl transition-shadow border border-gray-200 dark:border-gray-700">
      <div onClick={onClick} className="cursor-pointer">
        ...
        <h4 className="font-semibold text-lg mb-2 text-black dark:text-white mt-4">{nft.name}</h4>

        {nft.description && (
          <p className="text-sm text-black dark:text-gray-400 mb-3 line-clamp-2">
            {nft.description}
          </p>
        )}
            ...
            {!showListForm ? (
              ...
              <div className="space-y-2">
                <input
                  ...
                  placeholder="가격 (MTK)"
                  className="w-full px-2 py-1.5 border rounded-lg dark:bg-gray-700 dark:border-gray-600 bg-white dark:text-white text-black text-xs"
                  step="0.01"
                  min="0"
                  onClick={(e) => e.stopPropagation()}
                />
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        <div className="p-6">
          <div className="flex justify-between items-start mb-4">
            ...
            <button
              onClick={onClose}
              className="text-black dark:text-gray-300 text-2xl"
            >
              ✕
            </button>
          </div>
          ...
          <div className="space-y-4 mb-6">
            <div>
              <h3 className="text-sm font-medium text-black dark:text-gray-400 mb-1">
                Token ID
              </h3>
              <p className="text-lg font-mono text-black dark:text-white">{nft.tokenId.toString()}</p>
            </div>
            ...
            {details?.owner && (
              <div>
                ...
                <div className="flex items-center gap-2">
                  <code className="text-sm font-mono bg-gray-100 dark:bg-gray-700 text-black dark:text-gray-200 px-3 py-1 rounded">
                    {details.owner}
                  </code>
                  <a
          ...
          {(details?.description || nft.description) && (
            <div className="mb-6">
              <h3 className="text-sm font-medium text-black dark:text-gray-400 mb-2">
                설명
              </h3>
              <p className="text-black dark:text-gray-300 whitespace-pre-wrap">
                {details?.description || nft.description}
              </p>
            </div>
          )}
            ...
            <div className="mb-6">
              ...
              <div className="grid grid-cols-2 gap-2">
                {details.attributes.map((attr: any, index: number) => (
                  ...
                  >
                    <p className="text-xs text-black dark:text-gray-400 mb-1">
                      {attr.trait_type || '속성'}
                    </p>
                    <p className="text-sm font-semibold text-black dark:text-white">{attr.value}</p>
                  </div>
                ))}
              </div>
            </div>
